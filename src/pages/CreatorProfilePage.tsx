...
const profileCopy = {
  en: {
    ...
    editCopy: 'This static state shows where portfolio uploads, AI disclosure, availability, and rights preferences would be edited in a real account area.',
  ...
  ja: {
    ...
    editCopy: 'この静的状態は、実際のアカウント領域でポートフォリオ、AI開示、稼働状況、権利設定を編集する場所を示します。',
    portfolio: 'ポートフォリオ設定',
