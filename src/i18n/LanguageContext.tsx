...
const messages = {
  ...
  ja: {
    brandTagline: 'AI UXモックコンペ',
    browseContests: 'コンペを探す',
    creators: 'クリエイター',
    activeExample: '事例を見る',
    safety: '安全と責任',
    openContest: 'コンペを開始',
    ...
    language: 'English',
    heroTitle: '多数のUXモックを集めて、最も伝わる方向性を選ぶ。',
    heroCopy:
      'いくつかの質問に答えるだけで、AI支援クリエイターから複数のプロトタイプ案を集め、制作前に比較・選定できます。',
    startContest: 'コンペを開始',
    browseOpenContests: '募集中のコンペを見る',
    howItWorks: '流れを見る',
    liveContests: '募集中のデザインコンペ',
    liveContestCopy: '賞金、応募数、パッケージ、責任範囲タグを一覧で確認できます。',
    marketplaceFlow: 'コンペ型マーケットプレイス',
    prototypeOnly: 'プロトタイプ審査のみ',
    noProductionGuarantee: '本番制作保証なし',
    standardPrize: '標準賞金',
    expectedEntries: '想定応募数',
    productionGuarantee: '制作保証',
    pageBrowseTitle: 'デザインコンペを探す',
    pageBrowseCopy: 'カテゴリ、賞金、締切、パッケージ、責任範囲からUXモックコンペを探せます。',
    search: '検索',
    searchPlaceholder: 'コンペを検索',
    guaranteedOnly: '保証付きのみ',
    noContestsTitle: '条件に合うコンペがありません。',
    noContestsCopy: '条件をリセットするか、この案件に合う新しいコンペを開始してください。',
    ...
    noGenAi: '本番AIデータ禁止',
    footerCopy:
      'UXモック比較のためのプロトタイプです。本番開発、保守、商用リリース保証はこのプロトタイプの範囲外です。',
    ethicalResponsibility: '倫理と責任',
    realDataProhibited: '実データ禁止',
    selfTestsPassed: 'セルフテスト済み',
    contestNotFound: 'コンペが見つかりません',
    entryNotFound: '応募が見つかりません',
    backToContests: 'コンペ一覧へ戻る',
    backHome: 'ホームへ戻る',
    submitProposal: '提案を応募',
    consultWinner: '選択中の受賞候補を相談',
    ...
    firstSubmit: '最初の提案を応募する',
    noEntriesCopy: 'この静的コンペにはまだ応募データがありません。',
    selectAsWinner: '受賞候補にする',
    ...
    openMockContest: 'モックコンペを開始',
    openMockContestCopy:
      'UX方向性、画面モック、フロー案、安全境界を本番制作前に比較するための静的コンペを設定します。',
    contestDraftCreated: 'コンペ下書きを作成しました',
    contestDraftCopy: '静的プロトタイプ上で作成フローが完了しました。API送信やローカル保存は行っていません。',
    startAnotherContest: '別のコンペを開始',
    viewActiveExample: '事例を見る',
    readSafety: '安全を読む',
    safetyChecks: '安全確認',
    next: '次へ',
    back: '戻る',
    confirmMockContest: 'モックコンペを確定',
    category: 'カテゴリ',
    package: 'パッケージ',
    title: 'タイトル',
    goal: '目的',
    ...
    creatorPageCopy:
      '明確なプロトタイプ範囲のコンペに参加し、制作プロセスを示しながらショートリスト実績を作れます。',
...
const contestCopy: Record<Language, Record<number, { title: string; brief: string }>> = {
  ...
  ja: {
    1: {
      ...
      brief: '小規模サロンSaaS向けに、予約、スタッフ空き状況、リピート顧客フローを比較します。',
    },
    2: {
      title: '研究参加者スケジューリングツールのプロトタイプ',
      brief: '研究者が候補者の空き状況と同意確認を調整しやすくするスケジューリングフローを試作します。',
    },
    3: {
      title: '社内CSV処理ダッシュボードの情報設計',
      brief: 'CSV取り込み、検証、例外処理、レビューを扱う社内業務ダッシュボードをより明快にします。',
    },
    4: {
